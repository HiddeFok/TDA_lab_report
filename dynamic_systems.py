...
ax[0].scatter(data[0, 0, :, 0], data[0, 0, :, 1], s=[4 * 4] * 1000)
ax[0].set_title("Typical result for r=2")
#plt.savefig("figures/2_dynamic.png")

ax[1].scatter(data[1, 0, :, 0], data[1, 0, :, 1], s=[4 * 4] * 1000)
ax[1].set_title("Typical result for r=3.5")
#plt.savefig("figures/35_dynamic.png")

ax[2].scatter(data[2, 0, :, 0], data[2, 0, :, 1], s=[4 * 4] * 1000)
ax[2].set_title("Typical result for r=4")
#plt.savefig("figures/4_dynamic.png")

ax[3].scatter(data[3, 0, :, 0], data[3, 0, :, 1], s=[4 * 4] * 1000)
ax[3].set_title("Typical result for r=4.1")
#plt.savefig("figures/41_dynamic.png")

ax[4].scatter(data[4, 0, :, 0], data[4, 0, :, 1], s=[4 * 4] * 1000)
ax[4].set_title("Typical result for r=4.3")
plt.savefig("figures/figures_dynamic.svg", format="svg")
